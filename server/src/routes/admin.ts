...
/**
 * DELETE /api/admin/products/:id — dois caminhos, e a diferença importa.
 *
 * Por padrão é exclusão suave (`active = 0`): o produto sai da vitrine e os
 * pedidos antigos continuam mostrando o item, porque `order_items` aponta para
